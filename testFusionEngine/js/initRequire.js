...
(function () {
    ...
    require.config({
		...
		paths : {
		    ...
		    'core': 'mmirf/core'
	 	    ,'main': 'mmirf/main'
		    // lib
		    , 'jquery': 'mmirf/vendor/libs/jquery-1.11.1'
		    , 'jquery-ui': 'testFusionEngine/jquery-ui/jquery-ui.min'
     	    , 'scion': 'mmirf/vendor/libs/scion-amd'
     	    //lib alternative fusion engine
     	    , 'tv4': 'mmirf/vendor/libs/tv4'
     	    , 'math': 'mmirf/vendor/libs/math'
     	    , 'prototypeExtensions': 'mmirf/vendor/libs/prototypeExtensions'
		    ...
		    , 'inputManagerAlt': 'mmirf/manager/dialog/inputEngine'
			...
			, 'grammarParserTemplate' : 'mmirf/semantic/grammarParserTemplate'
			, 'semanticInterpreter' : 'mmirf/semantic/semanticInterpreter'

			// test Fusion Engine
			, 'fusionEngineSimulator': 'testFusionEngine/js/fusionEngineSimulator'
			, 'event': 'testFusionEngine/js/event'
	...
	var start = (function(){
		...
		define('jsonlint', function(){
			
			//////////////////////////// START copied contents of /build/lib/jsonlint.parser.min.js ////////////////////////
			...
			**/
			...
			//////////////////////////// END of /build/lib/jsonlint.parser.min.js ////////////////////////
			
			//export jsonlint parser as AMD for requirejs:
			return jsl.parser;
		});
	
		require(['jquery', 'jquery-ui' , 'constants', 'commonUtils', 'inputManager', 'inputManagerAlt', 'languageManager', 'semanticInterpreter', 'grammarConverter'
		         , 'jsonlint', 'fusionEngineSimulator' 
					
			], function(
					$, jqueryui ,constants, commonUtils, inputManager, inputManagerAlt, languageManager,semanticInterpreter,grammarConverter
					,jsonlint, fusionEngineSimulator
			) {
